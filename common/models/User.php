...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    public function rules()
    {
        return [
            ...
            /**
             * compare the repeat password with password
             * By default understands , appends (junta) _repeat to the password and compare
             * ['password' , 'compare']
    ...
    public function afterValidate()
    {
        ...
        if ($this->password ) {
            // generate the new hash to the new password
